  ...
  const { getRootProps, getInputProps, isDragActive, open } = useDropzone({
    ...
    onDropRejected: (rejectedFiles) => {
      ...
      if (file.errors[0].code === "file-too-large") {
        ...
        alert("فقط فایل‌های تصویر (JPG, PNG, GIF, WebP, SVG) مجاز هستند!");
      }
    },
  });
        ...
        >
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <h3 className="text-lg font-semibold text-gray-800">
              {isDragActive ? "رها کنید..." : "لطفا عکس مدرک تحصیلی خود را آپلود کنید"}
            </h3>
            <p className="text-sm text-gray-600">
              عکس را به اینجا بکشید یا با کلیک کردن انتخاب کنید
            </p>
            <p className="text-xs text-gray-500">
              فرمت‌های مجاز: JPG, PNG, GIF, WebP, SVG • حداکثر حجم: ۵MB
            </p>
            <Btn
              text="انتخاب فایل"
              type="button"
